...
func testAllowOverwrite(t *testing.T) {
	...
	require.True(t, AllowOverwrite(Kubernetes, XDS))
	...
	require.False(t, AllowOverwrite(CustomResource, XDS))
	...
	require.False(t, AllowOverwrite(KubeAPIServer, XDS))
	...
	require.True(t, AllowOverwrite(Directory, XDS))
	...
	require.True(t, AllowOverwrite(ClusterMesh, XDS))
	...
	require.True(t, AllowOverwrite(XDS, CustomResource))
	require.True(t, AllowOverwrite(XDS, KVStore))
	require.True(t, AllowOverwrite(XDS, Local))
	require.True(t, AllowOverwrite(XDS, KubeAPIServer))
	require.True(t, AllowOverwrite(XDS, XDS))
	require.False(t, AllowOverwrite(XDS, Kubernetes))
	require.False(t, AllowOverwrite(XDS, ClusterMesh))
	require.False(t, AllowOverwrite(XDS, Directory))
	require.False(t, AllowOverwrite(XDS, LocalAPI))
	require.False(t, AllowOverwrite(XDS, Generated))
	require.False(t, AllowOverwrite(XDS, Restored))
	require.False(t, AllowOverwrite(XDS, Unspec))
}
